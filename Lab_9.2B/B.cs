...
namespace Laba_9_2_1
{
            ...
            do
            {
                ...
                switch (menuItem)
                {
                    ...
                    case 7:
                        ...
                        StudentB.PrintAverageScore(in students);
                        break;
                    case 8:
    ...
    public class StudentB
    {
        ...
        public struct Student
        {
            ...
            [FieldOffset(40)] public double average;                       
        }
        ...
        public static void AverageScore(ref Student[] students)
        {
            for (int i = 0; i < students.Length; i++)
            {
                students[i].average = Math.Round((students[i].PhysicsGrade + students[i].MathGrade + students[i].ProgramingGrade) * 1.0 / 3, 2);
            }
        }
